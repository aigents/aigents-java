# Aigents Server Documentation
The following takes toghether resources on Aigents server building, testig, deployment, integration and operations.

1. [Aigents Server requirements, configuration, operation and API usage](aigents_server.md)
1. [Aigents Server Integration for News Syndication on Channel (Area) basis](aigents_integration_news_channel.md)
...
1. [Aigents Personal Social Reports](aigents_reports.md)
1. [Aigents News Monitoring — Tips and Tricks](https://medium.com/@aigents/aigents-news-monitoring-tips-and-tricks-ab8d2ede2fa5)
