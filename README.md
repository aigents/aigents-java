...
- **pdfbox-app-2.0.0-RC2.jar** ([Apache PDFBox Library](https://pdfbox.apache.org/) [version 2.0.0 RC2](http://central.maven.org/maven2/org/apache/pdfbox/pdfbox/2.0.0-RC2/pdfbox-2.0.0-RC2.jar)  - needed to parse PDF documents
